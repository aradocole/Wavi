...
// private final GcsService gcsSevice = GcsServiceFactory.createGcsService();
    ...
    HttpServletRequest other_req = req; */
        ...
        GcsFilename fileName = new GcsFilename("audiowavelet.appspot.com", "stayingalive.wav");
        ...
        try {
            ...
            String zipURL = doTransform("https://storage.googleapis.com/audiowavelet.appspot.com/stayingalive.wav");
            return zipURL;
